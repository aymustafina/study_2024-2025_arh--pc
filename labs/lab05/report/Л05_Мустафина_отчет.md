...
![1](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/1.jpg){#fig:001 width=70%}

Захожу в директорию ~/work/arch-pc (рис. [-@fig:002]).
![2](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/2.jpg){#fig:002 width=70%}

Создаю в этой директории папку с новым файлом с названием lab5-1.asm (рис. [-@fig:003]).
![3](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/3.jpg){#fig:003 width=70%}

Создание файла с помощью функции touch (рис. [-@fig:004]).
![4](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/4.jpg){#fig:004 width=70%}

Созданный файл (рис. [-@fig:005]).
![5](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/5.jpg){#fig:005 width=70%}

Открываю созданный файл с помощью функциональной клавиши F4 (рис. [-@fig:006]).
![6](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/6.jpg){#fig:006 width=70%}

Ввожу текст из листинга (рис. [-@fig:007]).  
![7](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/7.jpg){#fig:007 width=70%}
...
![8](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/8.jpg){#fig:008 width=70%}

Транслирую текст программы lab5-1.asm в объектный файл, выполняю компановку объектного файла и запускаю его (рис. [-@fig:009]).
![9](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/9.jpg){#fig:009 width=70%}

Запуск файла (рис. [-@fig:010]).
![10](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/10.jpg){#fig:010 width=70%}


## 5.3.1. Подключение внешнего файла in_out.asm

Скопировала файл ab5-1.asm с именем lab5-2.asm (рис. [-@fig:011]). 
![11](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/11.jpg){#fig:011 width=70%}

Я скачала файл in_out.asm со страницы курса в ТУИС и преместила его в каталог с программами лабораторной работы (рис. [-@fig:012]).
![12](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/12.jpg){#fig:012 width=70%}

Меняю текст в программе lab5-2.asm в соответствии с листингом 5.2 (рис. [-@fig:013]).
![14](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/14.jpg){#fig:014 width=70%}

Транслирую текст программы lab5-2.asm в объектный файл, выполняю компановку объектного файла (рис. [-@fig:014]).
![13](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/13.jpg){#fig:013 width=70%}
...
![15](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/15.jpg){#fig:015 width=70%}

Меняю текст в программе lab5-2.asm, заменив подпрограмму sprintLF на sprint (рис. [-@fig:016]).
![16](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/16.jpg){#fig:016 width=70%}

### Листинг 5.3. Измененная программа вывода сообщения на экран и ввода строки с клавиатуры c использованием файла in_out.asm
...
![17](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/17.jpg){#fig:017 width=70%}
...
![18](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/18.jpg){#fig:018 width=70%}
...
![19](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/19.jpg){#fig:019 width=70%}
...
![20](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/20.jpg){#fig:020 width=70%}

И вношу изменения в эту программу такие, что при запуске она выводит приглашение и просит ввести строку с клавиатуры, 
а после снова выводит введенную пользователем строку без перехода на новую строку (рис. [-@fig:021]).
![21](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/21.jpg){#fig:021 width=70%}

Запуск программы lab5-2-1.asm (рис. [-@fig:022]).
![22](https://github.com/aymustafina/study_2024-2025_arh--pc/blob/master/labs/lab05/report/image/22.jpg){#fig:022 width=70%}
